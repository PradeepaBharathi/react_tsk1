...
function App() {
  ...
  <div class="container">
    <div class="row">
      <div class="card">
      <div class="card-body">
        <h5 class="heading text-muted">FREE</h5>
        ...
        <ul class="fa-ul">
            ...
            <button type="button" class="btn btn-primary" id="btn1">BUTTON</button>
      </div>
      </div>
      
        <div class="card ">
          <div class="card-body">
            <h5 class="heading text-muted ">PLUS</h5>
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="heading text-muted ">PRO</h5>
